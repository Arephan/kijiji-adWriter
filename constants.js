const forSale = [{
    ...
    types: [
        ...
        { name: "iphone 6s 16gb", price: 215, dirName: "iphone-6s-16gb" },
        { name: "iphone 6s 32gb", price: 235, dirName: "iphone-6s-32gb" }
...
const personalKijijiAccounts = [
    {email : "hanilk2006@gmail.com", password: "200639"},
    {email : "hankimprod@gmail.com", password: "Helpyourself123*"}
]

const companyKijijiAcounts = [
    {email: "6@hankimproductions.com", password: "Kijijiforlife1*"}
]
